# Recomendaciones — Despliegue y operación
...
| API base | `/api/recomendaciones` |

## Docker

```bash
docker build -t duoc/jv0101-caso03-recomendaciones:1.0.0 .
docker run -p 8080:8080 duoc/jv0101-caso03-recomendaciones:1.0.0
```
